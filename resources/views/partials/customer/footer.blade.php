...
<footer style="background: radial-gradient(circle at 100% 0%, rgba(35, 83, 71, 0.22) 0%, transparent 45%), radial-gradient(circle at 0% 100%, rgba(35, 83, 71, 0.16) 0%, transparent 40%), #051F20;"
        class="border-t border-emerald-950/45 relative overflow-hidden pt-16 pb-12">
    
    {{-- Decorative glowing blobs --}}
    <div class="absolute -right-20 -bottom-20 w-80 h-80 rounded-full filter blur-[120px] opacity-25 pointer-events-none" style="background:#235347;"></div>
    <div class="absolute -left-20 top-0 w-80 h-80 rounded-full filter blur-[100px] opacity-15 pointer-events-none" style="background:#0B2B26;"></div>

    <div class="max-w-[1200px] mx-auto px-6 relative z-10">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-12">

            <!-- Brand Column -->
            <div class="md:col-span-5 space-y-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <!-- Links Column -->
            <div class="md:col-span-3 space-y-5" data-aos="fade-up" data-aos-delay="200">
                <h4 class="text-xs font-extrabold uppercase tracking-widest" style="color: #8EB69B;">Navigasi Menu</h4>
                <ul class="space-y-3.5">
                    ...
                    <li>
                        <a href="{{ route($link['route']) }}"
                           ...
                           style="color: #F1F5F9;"
                           onmouseover="this.style.color='#8EB69B';" onmouseout="this.style.color='#F1F5F9';">
            ...
            <!-- Contact/Info Column -->
            <div class="md:col-span-3 space-y-5" data-aos="fade-up" data-aos-delay="300">
                <h4 class="text-xs font-extrabold uppercase tracking-widest" style="color: #8EB69B;">Layanan Informasi</h4>
                <ul class="space-y-4">
                    <li class="flex items-start gap-3 text-sm font-semibold" style="color: #F1F5F9;">
                        <span class="material-symbols-outlined shrink-0" style="font-size: 20px; color: #8EB69B;">location_on</span>
                        <span class="leading-relaxed">Sidoarjo, Jawa Timur,<br><span class="text-xs font-medium text-slate-350" style="color: #94A3B8;">Indonesia</span></span>
                    </li>
        ...
        <!-- Divider Line -->
        <div class="h-px bg-slate-800 my-10" style="background: linear-gradient(90deg, rgba(226,232,240,0.01) 0%, rgba(142,182,155,0.2) 50%, rgba(226,232,240,0.01) 100%);"></div>

        <!-- Bottom Row -->
        <div class="flex flex-col sm:flex-row justify-between items-center gap-4 text-center sm:text-left" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="flex items-center gap-6">
                <a href="#" class="text-xs font-semibold transition-colors" style="color: #CBD5E1;"
                   onmouseover="this.style.color='#8EB69B';" onmouseout="this.style.color='#CBD5E1';">
                    Kebijakan Privasi
                </a>
                <a href="#" class="text-xs font-semibold transition-colors" style="color: #CBD5E1;"
                   onmouseover="this.style.color='#8EB69B';" onmouseout="this.style.color='#CBD5E1';">
